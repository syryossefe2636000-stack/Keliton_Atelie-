...
// Garante que o diretório de dados exista antes de criar arquivos de sessão/biometria.
// Isso corrige a falha que fazia o servidor encerrar ao iniciar em hospedagens novas.
...
function readState(){return readJson(STATE_FILE,{products:null,music:Array(6).fill(null),active:-1,seller:{name:'Keliton Ateliê',whatsapp:'',pixKey:'',pixUrl:''},gmail:{connected:false,email:''}})}
